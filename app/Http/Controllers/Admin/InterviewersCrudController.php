...
use App\Http\Requests\InterviewersRequest as StoreRequest;
use App\Http\Requests\InterviewersRequest as UpdateRequest;

class InterviewersCrudController extends CrudController
{
    public function setup()
    {
        ...
        |--------------------------------------------------------------------------
        */
        $this->crud->setModel('App\Models\Interviewers');
        $this->crud->setRoute(config('backpack.base.route_prefix') . '/interviewers');
        $this->crud->setEntityNameStrings('interviewers', 'interviewers');
